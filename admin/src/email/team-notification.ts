    ...
    html: `
      <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #1B3B5E;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
          ...
          <tr><td style="padding: 6px 0; color: #697686;">Preferred Date</td><td style="padding: 6px 0;">${data.preferredDate || '—'}</td></tr>
          <tr><td style="padding: 6px 0; color: #697686;">Time Preference</td><td style="padding: 6px 0;">${data.timePreference ? TIME_PREFERENCE_LABELS[data.timePreference] || data.timePreference : '—'}</td></tr>
